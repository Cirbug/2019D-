...
void Page2_Update(void)
{
    ...
    else
    {
        ...
        // 低电平通道（左侧）
        POINT_COLOR = GRAY;
        LCD_Fill(55, 58, 160, 80, WHITE);
        LCD_Fill(55, 81, 160, 103, WHITE);
        LCD_Fill(55, 104, 160, 126, WHITE);
        LCD_Fill(55, 127, 160, 149, WHITE);
        LCD_ShowNum(55, 58, p2_adc1_low, 4, 16);
        LCD_ShowNum(55, 81, p2_adc2_low, 4, 16);
        LCD_ShowNum(55, 104, p2_adc3_ac_low, 4, 16);
        LCD_ShowNum(55, 127, p2_adc3_dc_low, 4, 16);

        // 高电平通道（右侧）
        POINT_COLOR = BLACK;
        LCD_Fill(225, 58, 315, 80, WHITE);
        LCD_Fill(225, 81, 315, 103, WHITE);
        LCD_Fill(225, 104, 315, 126, WHITE);
        LCD_Fill(225, 127, 315, 149, WHITE);
        LCD_ShowNum(225, 58, p2_adc1_high, 4, 16);
        LCD_ShowNum(225, 81, p2_adc2_high, 4, 16);
        LCD_ShowNum(225, 104, p2_adc3_ac_high, 4, 16);
        LCD_ShowNum(225, 127, p2_adc3_dc_high, 4, 16);
